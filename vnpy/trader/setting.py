...
SETTINGS: dict = {
    ...
    "concept.ingestion.enabled": True,
    "concept.ingestion.providers": "broker,local_catalog,akshare",
    "concept.ingestion.schedule": "09:00",
    "concept.ingestion.catalog_path": "",
    "concept.ingestion.max_boards_per_run": 20,
    "concept.ingestion.max_concepts_per_symbol": 3,
    "concept.ingestion.refresh_interval_hours": 24,
    "concept.ingestion.akshare.max_retries": 3,
    "concept.ingestion.akshare.retry_backoff_seconds": 2.0,
    ...
    "seven_boll.scan.latest_daily_ttl_seconds": 900,
