...
SETTING_HELP_TEXT: dict[str, str] = {
    ...
    "financial.ingestion.symbols": "财报入库关注标的列表，逗号分隔；留空时跟随 financial.ingestion.catalog_path 或 news.entity.catalog_path 股票池分批慢速回补，不在启动时全市场拉取。",
    "financial.ingestion.catalog_path": "财报入库股票池 CSV/JSON 路径；留空时复用 news.entity.catalog_path。",
