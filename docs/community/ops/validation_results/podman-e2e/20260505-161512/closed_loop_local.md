...
- 生成时间：`2026-05-05T08:16:24+00:00`
- profile：`local`
...
| pytest_non_alpha | passed | yes | `uv run --with pytest --with psycopg2-binary pytest tests -q --ignore=tests/test_alpha101.py` | command passed |
...
本次验证满足 production profile 的所有生产必需门禁。
